...
class GoogleOAuthServiceTest {
    ...
    void successGetToken() throws Exception {
        ...
        com.sporty.backend.auth.dto.GoogleAuthResponse expectedResponse = com.sporty.backend.auth.dto.GoogleAuthResponse.builder()
        ...
        com.sporty.backend.auth.dto.GoogleAuthResponse actualResponse = googleOAuthService.getOAuthToken(code);
    ...
    void successGetUserInfo() throws Exception {
        ...
        com.sporty.backend.auth.dto.GoogleUseInfo expectedResponse = com.sporty.backend.auth.dto.GoogleUseInfo.builder()
                .email("test@test.com")
                .verifiedEmail("true")
                .picture("picture")
                .socialId("1234")
        ...
        com.sporty.backend.auth.dto.GoogleUseInfo actualResponse = googleOAuthService.getUserInfo(accessToken);
